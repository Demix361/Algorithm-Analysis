...
void controller() {
    ...
    mult_matrix_std(matr_1, matr_2, res_matr_1);
    print_matr(res_matr_1, "Result of multiplication of standard:\n");

    mult_matrix_vinograd(matr_1, matr_2, res_matr_2);
    print_matr(res_matr_2, "Result of multiplication by Vinograd:\n");

    mult_matrix_vinograd_optimiz(matr_1, matr_2, res_matr_3);
